## You're on the helper-only branch. Switch [back to main branch](https://github.com/veerserif/gamma-dx8-and-dx9/tree/main) if you aren't a GAMMA Discord helper.
...
5. Open MO2
6. Select the "GAMMA DX8 and DX9 - 0.9.4" mod profile. You should have **537** mods enabled by default.
